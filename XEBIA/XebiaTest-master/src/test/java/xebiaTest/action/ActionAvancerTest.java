...
public class ActionAvancerTest {
    ...
    public void testOperationSpec() throws Exception {
        ...
        Tondeuse t3 = gauche.operation(EnvironnementGenerator.getDirection('A'), t2);
        Assert.assertTrue(t3.getOrientation().toString().equals("EST"));
        Assert.assertTrue(t3.getPossition().getX() == 1);
